...
from configs.overhanging_cfg2 import OverhangingTerrainPattern, OverhangingPattern, OverhangingFloorPattern
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mesh_dir", type=str, default="results/generated_terrain_cus3", help="Directory to save the generated mesh files"
    )
